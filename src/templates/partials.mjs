...
export const MORE = [
  ...
  ['compare', 'compare/', 'Compare two'],
  ['graph', 'graph/', 'The graph'],
  ['projects', 'projects/', 'The replication projects'],
  ['published-in', 'published-in/', 'Where they were published'],
...
export const FOOT_COLS = [
  ['Browse', [
    ...
    ['timeline/', 'Timeline'],
    ['published-in/', 'Where they were published'],
  ...
  ['Discover', [
    ...
    ['sheets/', 'Cheat sheets'],
    ['compare/', 'Compare two biases'],
    ['graph/', 'The graph'],
    ['projects/', 'The replication projects'],
...
const MORE_GLOSS = {
  ...
  'compare/': 'the pairs people mix up, side by side',
  'graph/': 'walk the index one neighbourhood at a time',
  'projects/': 'the studies that retested many of these at once',
  'published-in/': 'the journals these first appeared in',
